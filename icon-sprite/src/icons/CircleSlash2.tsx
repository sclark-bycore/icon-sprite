import { CircleSlash2 as DevIcon, type LucideProps } from "lucide-react"
...
export function CircleSlash2({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#circle-slash-2`} />
    </svg>
  );
}
