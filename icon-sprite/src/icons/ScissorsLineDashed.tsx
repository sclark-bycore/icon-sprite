import { ScissorsLineDashed as DevIcon, type LucideProps } from "lucide-react"
...
export function ScissorsLineDashed({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#scissors-line-dashed`} />
    </svg>
  );
}
