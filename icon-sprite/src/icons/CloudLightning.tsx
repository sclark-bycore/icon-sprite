import { CloudLightning as DevIcon, type LucideProps } from "lucide-react"
...
export function CloudLightning({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#cloud-lightning`} />
    </svg>
  );
}
