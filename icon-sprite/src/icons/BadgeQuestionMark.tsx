import { BadgeQuestionMark as DevIcon, type LucideProps } from "lucide-react"
...
export function BadgeQuestionMark({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#badge-question-mark`} />
    </svg>
  );
}
