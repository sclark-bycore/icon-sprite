import { NotepadTextDashed as DevIcon, type LucideProps } from "lucide-react"
...
export function NotepadTextDashed({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#notepad-text-dashed`} />
    </svg>
  );
}
