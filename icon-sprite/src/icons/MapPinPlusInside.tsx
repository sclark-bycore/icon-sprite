import { MapPinPlusInside as DevIcon, type LucideProps } from "lucide-react"
...
export function MapPinPlusInside({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#map-pin-plus-inside`} />
    </svg>
  );
}
