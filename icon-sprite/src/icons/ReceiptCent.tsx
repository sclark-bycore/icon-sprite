import { ReceiptCent as DevIcon, type LucideProps } from "lucide-react"
...
export function ReceiptCent({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#receipt-cent`} />
    </svg>
  );
}
