import { CalendarX2 as DevIcon, type LucideProps } from "lucide-react"
...
export function CalendarX2({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#calendar-x-2`} />
    </svg>
  );
}
