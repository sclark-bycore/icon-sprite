import { FileVideo2 as DevIcon, type LucideProps } from "lucide-react"
...
export function FileVideo2({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#file-video-2`} />
    </svg>
  );
}
