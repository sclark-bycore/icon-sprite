import { UserRoundPen as DevIcon, type LucideProps } from "lucide-react"
...
export function UserRoundPen({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#user-round-pen`} />
    </svg>
  );
}
