import { CornerLeftUp as DevIcon, type LucideProps } from "lucide-react"
...
export function CornerLeftUp({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#corner-left-up`} />
    </svg>
  );
}
