import { ScanBarcode as DevIcon, type LucideProps } from "lucide-react"
...
export function ScanBarcode({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#scan-barcode`} />
    </svg>
  );
}
