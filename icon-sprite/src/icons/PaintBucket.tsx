import { PaintBucket as DevIcon, type LucideProps } from "lucide-react"
...
export function PaintBucket({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#paint-bucket`} />
    </svg>
  );
}
