import { FolderOpenDot as DevIcon, type LucideProps } from "lucide-react"
...
export function FolderOpenDot({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#folder-open-dot`} />
    </svg>
  );
}
