import { AlarmClockCheck as DevIcon, type LucideProps } from "lucide-react"
...
export function AlarmClockCheck({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#alarm-clock-check`} />
    </svg>
  );
}
