import { MapPinCheckInside as DevIcon, type LucideProps } from "lucide-react"
...
export function MapPinCheckInside({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#map-pin-check-inside`} />
    </svg>
  );
}
