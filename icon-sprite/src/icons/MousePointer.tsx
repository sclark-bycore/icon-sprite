import { MousePointer as DevIcon, type LucideProps } from "lucide-react"
...
export function MousePointer({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#mouse-pointer`} />
    </svg>
  );
}
