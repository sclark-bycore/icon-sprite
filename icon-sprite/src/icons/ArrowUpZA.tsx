import { ArrowUpZA as DevIcon, type LucideProps } from "lucide-react"
...
export function ArrowUpZA({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#arrow-up-z-a`} />
    </svg>
  );
}
