import { BrainCircuit as DevIcon, type LucideProps } from "lucide-react"
...
export function BrainCircuit({ size, width, height, ...props }: Props) {
  ...
  return process.env.NODE_ENV !== "production" ? (
    ...
    <svg
      ...
      {...(height != null ? { height } : {})}
    >
      <use href={`${SPRITE_PATH}#brain-circuit`} />
    </svg>
  );
}
